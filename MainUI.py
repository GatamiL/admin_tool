...
class Gui:
    def __init__(self):
        ...
        self.edit.pack(side=LEFT,padx=10, pady=10)
        self.edit = tk.Button(self.window, text="Отлеживать состояние")
        self.edit.pack(side=LEFT,padx=10, pady=10)
        ...
        self.tree.insert('', 'end', values=("100", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("101", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("102", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("103", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("104", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("105", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("106", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("100", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("101", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("102", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("103", "192.168.254.254", "Сервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер ПрограммистовСервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("104", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("105", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("106", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
        self.tree.insert('', 'end', values=("100", "192.168.254.254", "Сервер Программистов", "online","о","Изменить"))
